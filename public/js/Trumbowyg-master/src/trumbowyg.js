...
function initTrumbowyg(target) {
    ...
    target.trumbowyg({
        ...
        btns: [
            ['viewHTML'], // Switch code source / texte brut
            ['formatting'], // Liste des titres et paragraphes
            ['strong', 'em', 'del'], // Font-weight
            ['link'], // Insertion de liens
            ['image'], // Insertion d'images (upload ou via url)
            ['justifyLeft', 'justifyCenter', 'justifyRight', 'justifyFull'], // Positionnement du texte
            ['unorderedList', 'orderedList'], // Liste Ã  puce / Chiffres
            ['horizontalRule'], // InsÃ¨re un hr
            ['removeformat'], // EnlÃ¨ve le formattage du texte
            ['fullscreen'], // Plein Ã©cran
            ['noembed'], // Insertion de lien youtube
        ],
        plugins: {
            upload: {
                // ParamÃ¨tre du plugin upload : insÃ¨re l'image dans un sous dossier prenant le nom du composant
                serverPath: '/public/img/uploads',
                fileFieldName: 'image',
